...
import frc.robot.commands.RaiseToSetPoint;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // final JoystickButton raiseElevatorButton = new JoystickButton(mSecondaryController, Button.kA.value);
    // raiseElevatorButton.whenPressed(new RaiseToSetPoint(mElevator, setpoint, mDumpMechanism));
