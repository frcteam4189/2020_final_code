...
public final class Constants {
    ...
    public static final class DriveSensorConstants{
        public static final int kLeftUltrasonicPort = 1;
        public static final int kFrontUltrasonicPort = 2;
        public static final int kRightTopUltrasonicPort = 3;
        public static final int kRightBottomUltrasonicPort = 0;
        public static final int kVoltToDistance = 0;
    ...
    public static final class DumperConstants{
        ...
        public static final int kSolenoidPort = 2;
    }
    
    public static final class ElevatorConstants{
        public static final int kElevatorTalonID = 3;
        public static final int kAdjusmentTalonID = 7;
        public static final int kElevatorSolenoidPort = 0;
        public static final int kSlotIdx = 0;
